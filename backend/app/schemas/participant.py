...
class ParticipantUpdate(BaseModel):
    ...
    NOTE: The following fields are intentionally excluded from this schema:
    - 'confirmed': User confirmation status can ONLY be changed through the official
      confirmation endpoints (/confirm/accept or /confirm/decline), which ensure
      proper workflow execution including credential generation, terms acceptance,
      and audit logging.
    - 'pandas_username': Usernames are auto-generated by the system and cannot be
      manually edited to ensure consistency and avoid conflicts.
    """
